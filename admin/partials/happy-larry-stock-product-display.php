...
<div class="wrap">
    <div class="main_title">
        ...
        <p>
            ...
            <br>
            "Heure location lendemain" : Fixe heure limite pour louer le produit le lendemain.
        </p>
    </div>
    <div class="main_content">
        <table class="table table-striped">
            ...
            <tr>
                ...
                <th scope="col">Heure location lendemain</th>
            </tr>
            </thead>
            <tbody>
            <?php foreach ($products as $product) :
                ...
                $number_of_stock = $product->get_stock_quantity();
...
//                echo "<pre>"; print_r($rent_limit_time); echo "<pre>";
                ?>
                <tr>
                    ...
                    <td>
                        ...
                        <select name="restock_option" class="restock_category <?php echo $restock_class; ?>" data-product-id="<?php echo $product_id ?>" >
                            ...
                            <option value="<?php echo $restock_auto ?>" <?php echo in_array($restock_auto, $product_categories) ? "selected" : "" ; ?>>Restock jour même</option>
                    ...
                    <td>
                        ...
                        <select name="rent_type" class="rent_category <?php echo $rent_class; ?>" data-product-id="<?php echo $product_id ?>" >
                            ...
                            <option value="<?php echo $location_indiv ?>" <?php echo in_array($location_indiv, $product_categories) ? "selected" : "" ; ?>>Location individuelle</option>
                    ...
                    <td>
                        <!--Select for the Location Type Category-->
                        <select name="time_period" class="time_period" data-product-id="<?php echo $product_id ?>">
                            <option value="" disabled >Sélectionnez une option</option>
                            <option value="" <?php echo $rent_limit_time === '' ? 'selected' : '' ; ?>>Réinitialiser</option>
                            <?php for ($i = 0; $i < 24; $i++) : ?>
        ...
        <button id="send_period"">Sauver les changements</button>
    </div>